# ✍️ COPIES META ADS USA — MAYO 2026

**Última actualización:** 30 abril 2026  
**Responsable:** Marta Servián (Team4Digital)  
**Campaña:** Brand Awareness — Vídeo Presencia Ferias (USA)  
**Idioma:** English (American)

---

## 🎬 VÍDEO: BRANDING FERIAS — BRAND AWARENESS USA

**Objetivo campaña:** Brand Awareness / Reach / Ganar seguidores @cortagusa  
**Público:** Tile professionals, tile contractors, tile pros — United States  
**Tono:** Casual professional, empowering, pro community  
**CTA botón recomendado:** Follow Page (seguidores) + Learn More (awareness)

**Asset:** Vídeo presencia ferias sector (corporativo, sin voz en off — universal)  
**Ventaja:** Universal, sin idioma → válido para mercado USA sin modificaciones
...
## 📊 RECOMENDACIÓN A/B TESTING

| Anuncio | Copy | CTA | Objetivo específico |
|---------|------|-----|---------------------|
| `AW_Ferias_USA_V1` | Variación 1 | Follow Page | Seguidores + Brand |
| `AW_Ferias_USA_V5` | Variación 5 | Follow Page | Seguidores |
| `AW_Ferias_USA_V3` | Variación 3 | Learn More | Awareness puro |

**Test inicial recomendado:** Lanzar V1 + V5 (ambas CTA Follow Page) y V3 (Learn More).  
Tras 4-5 días, pausar la de peor rendimiento en CTR y coste por seguidor.
...
**Archivo campaña completo:** `../campaigns/campaign_config_mayo2026_usa.md`  
**Banco copies reutilizables:** `copies_ads_usa_banco.md`  
